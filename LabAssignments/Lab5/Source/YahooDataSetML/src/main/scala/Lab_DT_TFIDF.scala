...
object Lab_DT_TFIDF {
  def main(arg:Array[String]) : Unit =
  {
    ...
    val topic_output = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\DT_Results_TFIDF.txt")
    val QFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\Q_FV_DT__TFIDF.txt")
    val AFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\A_FV_DT_TFIDF.txt")
