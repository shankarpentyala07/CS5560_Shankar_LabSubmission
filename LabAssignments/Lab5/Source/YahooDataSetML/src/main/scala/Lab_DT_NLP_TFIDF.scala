...
/**
  ...
  */
object Lab_DT_NLP_TFIDF {
def main(arg:Array[String]) : Unit =
{
  System.setProperty("hadoop.home.dir", "F:\\winutils")
  val conf = new SparkConf().setAppName("DT").setMaster("local[*]").set("spark.driver.memory", "4g").set("spark.executor.memory", "4g")
  val sc = new SparkContext(conf)

  Logger.getRootLogger.setLevel(Level.WARN)

  val topic_output = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\DT_Results_NLP_TFIDF.txt")
  val QFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\Q_FV_DT_NLP_TFIDF.txt")
  val AFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\A_FV_DT_NLP_TFIDF.txt")
