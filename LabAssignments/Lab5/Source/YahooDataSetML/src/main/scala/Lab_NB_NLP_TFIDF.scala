...
/**
  ...
  */
object Lab_NB_NLP_TFIDF {
  def main(args: Array[String]): Unit = {


    System.setProperty("hadoop.home.dir", "F:\\winutils")
    val conf = new SparkConf().setAppName("NB").setMaster("local[*]").set("spark.driver.memory", "4g").set("spark.executor.memory", "4g")
    val sc = new SparkContext(conf)

    Logger.getRootLogger.setLevel(Level.WARN)

    val topic_output = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\NB_Results.txt")
    val QFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\Q_FV_NB.txt")
    val AFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\A_FV_NB.txt")
