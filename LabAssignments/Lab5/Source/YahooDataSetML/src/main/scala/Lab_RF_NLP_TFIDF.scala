...
object Lab_RF_NLP_TFIDF {
  def main(args:Array[String]) :Unit =
  {
    ...
    val topic_output = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\RF_Results_NLP_TFIDF.txt")
    val QFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\Q_FV_RF_NLP_TFIDF..txt")
    val AFV = new PrintStream("C:\\Users\\shankar pentyala\\IdeaProjects\\YahooDataSetML\\Data\\A_FV_RF_NLP_TFIDF..txt")
