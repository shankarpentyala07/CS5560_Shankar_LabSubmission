...
object  OntContructorMain {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ONTOLOGYURI="http://www.semanticweb.org/shankar/ontologies/2017/6/"

    val manager = OWLManager.createOWLOntologyManager
    //creating ontology manager
    val df = manager.getOWLDataFactory //In order to create objects that represent entities

    val ontology = manager.createOntology(IRI.create(ONTOLOGYURI,"cricket#"))
    //Prefix for all the entities
    val pm = new DefaultPrefixManager(null, null, ONTOLOGYURI+"cricket#")
   //*********************************************************************************
    ...
    val classes=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Classes").getLines()
    ...
    val subClasses=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\SubClasses").getLines()
    ...
    val objprop=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\ObjectProperties").getLines()
    objprop.foreach(f=> {
      val farr=f.split(",")
    ...
    val dataprop=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\DataProperties").getLines()
    ...
    val individuals=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Individuals").getLines()
    ...
    val triplets=Source.fromFile("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\Triplets").getLines()
    triplets.foreach(f=>{
      val farr=f.split(",")
    ...
    val os = new FileOutputStream("C:\\KDM\\CS5560-Tutorial-6-SourceCode\\OntContructor\\data\\family.owl")
